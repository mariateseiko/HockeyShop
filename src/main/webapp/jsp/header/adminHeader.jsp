...
<div class="header-image">
  <header>
    <div class="dropdown-wrapper" id="left-menu" ng-controller="menuController">
      <button class="dropdown-button"  id="left-menu-button" ng-click="leftClick()">
    ...
    <div class="dropdown-wrapper" id="right-menu" ng-controller="menuController">
      ...
      <nav class="dropdown dropdown-is-active" id="right-dropdown" ng-show="showRight">
        <ul class="dropdown-content">
          <li class="cd-divider"><fmt:message key="label.orders"/></li>
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_all_orders">
              <fmt:message key="label.orders.all"/>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_all_orders&type=paid">
              <fmt:message key="label.orders.paid"/>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_all_orders&type=unpaid">
              <fmt:message key="label.orders.unpaid"/>
            </a>
          </li>
          <li class="cd-divider"><fmt:message key="label.users"/></li>
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_users_list&type=unpaid">
  ...
  <div id="wrapper">
    <div class="test">
      ...
      <a href="controller?command=view_all_orders"><button style="margin-top: 4px">
        <fmt:message key="admin.button.center"/>
      </button></a>
    </div>
  </div>
</div>
