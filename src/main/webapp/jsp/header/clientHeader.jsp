    ...
    <div class="dropdown-wrapper" id="right-menu" ng-controller="menuController">
      ...
      <nav class="dropdown dropdown-is-active" id="right-dropdown" ng-show="showRight">
        <ul class="dropdown-content">
          ...
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_user_orders">
              <fmt:message key="label.orders.all"/>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_user_orders&type=paid">
              <fmt:message key="label.orders.paid"/>
            </a>
          </li>
          <li>
            <a href="${pageContext.request.contextPath}/controller?command=view_user_orders&type=unpaid">
